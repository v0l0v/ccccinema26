    ...
    <div id="roulette-overlay" class="roulette-overlay">
        ...
        <div class="roulette-content">
            <div style="position: relative; display: inline-block;">
                <div style="position: absolute; left: -360px; top: 50%; z-index: 0; pointer-events: none; animation: plant-breathe 2.5s ease-in-out infinite;">
                    <img src="soloplanta.png" alt="Planta carnívora" style="width: 550px; filter: drop-shadow(0 15px 30px rgba(0,0,0,0.9));">
                </div>
