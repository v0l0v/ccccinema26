...
<body>
    ...
    <div id="roulette-overlay" class="roulette-overlay">
        ...
        <div class="roulette-vignette" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at center, transparent 15%, rgba(11, 15, 25, 0.95) 85%); z-index: -1; pointer-events: none;"></div>
        <style>
