...
replacements = {
    ...
    "Ver cartel en grande": "Vore cartell en gran",
    ...
    "Compartir": "Compartir",
    "Generar": "Generar",
    "Descargar la entrada para compartir en redes sociales": "Descarregar l'entrada per a compartir en xarxes socials",
    ...
    "Ver Mi Diario": "Vore el Meu Diari",
    ...
    "Mantén pulsada la imagen para enviarla, o usa el botón de descargar.": "Mantingues premuda la imatge per a enviar-la, o utilitza el botó de descarregar.",
